...
setsubmenuindex3(null);
  ...
  return (
    <>
    <div className={`sidebar fixed top-0 left-0 bg-[#fff] border-r border-[rgba(0,0,0,0.1)]  h-full py-2 px-2 ${context.issidebaropen===true ? 'w-[17%]': 'w-0'} overflow-hidden transition-all duration-500`}>
