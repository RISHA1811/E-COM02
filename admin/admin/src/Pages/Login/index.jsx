            ...
            <div className="login">
              <div className="card shadow-md m-auto w-[600px] bg-[#f1f1f1] !rounded-lg p-4">
                ...
                <div className="form-group w-full pt-5 px-8 relative">
                  <TextField type={isshowpassword ? 'text' : 'password'} id="Password" label="Password *" variant="outlined" className='w-full mb-5' name='password' value={password} onChange={(e) => setPassword(e.target.value)} />
                ...
                <div className='text-left mt-2 px-8'>
                  <Link to="/forgotpassword" className="link text-left cursor-pointer text-[14px] font-[600]">Forgot Password?</Link>
                </div>

                <div className="flex items-center w-full mt-6 mb-4 px-8">
                  <Button className='btn-blue !btn-lg w-[100%] !text-[18px] !text-[#fff]' onClick={handleLogin}>Sign in</Button>
                </div>

                <div className='px-8'>
                  Not Registered? <Button className='link font-[500] text-[14px] text-primary' onClick={() => navigate('/signup')}>Sign Up</Button>
                </div>
                ...
                <div className="icons flex items-center justify-between gap-3 px-8">
                  ...
                  <Button className='flex gap-3 !bg-lg text-[20px] !bg-gray-200 w-full !mt-2 btn-sm !text-black'><FaApple className='text-[30px]' /> Login with Apple</Button>
                </div>
              </div>
            </div>
          </div>
