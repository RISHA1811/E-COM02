...
const label = { inputProps: { 'aria-label': 'Checkbox demo' } };
  ...
  <h2 className='text-[25px] font-[700]'>Category List</h2>

  <div className='col2 w-[30%] flex items-center justify-end gap-3  ml-auto'>
      <Button className='btn !bg-green-600 !text-[#fff] !font-[500] btn-sm flex gap-2'><BiExport className='!text-[20px]'/>Export</Button>
      <Button className='btn-blue !bg-green-600 !text-[#fff] !font-[500] btn-sm flex gap-1' onClick={()=>context.setisopenfullscreenpanel({open:true,model:'Add New Category'}) } ><IoMdAdd className='!text-[20px]' />Add New Category</Button>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-black-500 text-black-400">
        <thead class="text-xs text-gray-700 uppercase bg-black-50 bg-black-700 text-black-400">
            <tr>
                ...
                <th scope="col" className="px-0 text-[14px] py-3 whitespace-nowrap w-[320px]">
                  Category Image
                </th>
                 <th scope="col" className="px-5 text-[14px] py-3 whitespace-nowrap w-[220px]">
                  Category Name
                </th>
                <th scope="col" className="px-20  text-[14px] py-3 whitespace-nowrap  ">
                    Action
                </th>
