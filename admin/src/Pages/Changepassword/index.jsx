...
<h3 className='text-[40px] font-[700]  text-center '>You Can Change Your Password from here </h3>

                    
<div className="form-group w-full pt-5 px-8 relative">
      <TextField type={isshowpassword===true ? 'text': 'password'} id="Password" label="New Password *" variant="outlined" className='w-full mb-5' name='name'  />
      <Button className='!absolute top-[30px] right-[40px] z-50 !rounded-full !w-[35px] !h-[35px] !min-w-[35px] ' onClick={()=>setisshowpassword(!isshowpassword)}>
...
<div className="form-group w-full pt-5 px-8 relative">
      <TextField type={isshowpassword2===true ? 'text': ' password'} id="Password" label=" Confirm Password *" variant="outlined" className='w-full mb-5' name='name'  />
      <Button className='!absolute top-[30px] right-[40px] z-50 !rounded-full !w-[35px] !h-[35px] !min-w-[35px] ' onClick={()=>setisshowpassword2(!isshowpassword2)}>
        
        {
          isshowpassword2===true ?         <IoMdEye className='text-gray-600 text-[18px]'/>
:
        <FaEyeSlash className='text-gray-600 text-[18px]'/>
   ...
   <div className="flex items-center w-full mt-6 mb-4 px-8">
                      <Button className='btn-blue !btn-lg  w-[100%] !text-[18px]   !text-[#fff] '>Change Password </Button>
                    </div>
